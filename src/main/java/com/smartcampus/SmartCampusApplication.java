...
public class SmartCampusApplication {
        ...
        public CommandLineRunner dataLoader(EventRepository eventRepository,
                ...
                return args -> {
                        ...
                        if (registrationRepository.count() == 0 && springBootBootcamp != null && researchSeminar != null
                                        && careerFair != null) {
                                ...
                                // Use the other fetched events to avoid unused variable warnings
                                if (hackathon != null) {
                                        registrationRepository.save(new Registration(null,
                                                        hackathon.getId(),
                                                        hackathon.getTitle(),
                                                        ...
                                                        0,
                                                        "Exciting hackathon! Looking forward to it."));
                                }
                                if (designSprint != null) {
                                        registrationRepository.save(new Registration(null,
                                                        designSprint.getId(),
                                                        designSprint.getTitle(),
                                                        "Demo Student",
                                                        "student@univ.edu",
                                                        "Computer Science",
                                                        LocalDateTime.now().minusDays(3),
                                                        3,
                                                        "Great design workshop with practical tools."));
                                }
                                if (culturalNight != null) {
                                        registrationRepository.save(new Registration(null,
                                                        culturalNight.getId(),
                                                        culturalNight.getTitle(),
                                                        "Demo Student",
                                                        "student@univ.edu",
                                                        "General",
